  ...
  <div id="ventanaFormularioCrearMedico" class="oculto">
    ...
    <form  name="formularioCrearMedico" id="formularioCrearMedico" >
        <table class="tabla" align="center">
		  ...
		  <tr>
              <td>Sexo:&nbsp;</td>
              <td><input required type="text" name="txt_sexo" id="txt_apellido_m"></td>
          </tr>
		  <tr>
              <td>Fecha Nacto:&nbsp;</td>
              <td><input required type="text" name="txt_fecha_n" id="txt_apellido_m"></td>
          </tr>
		  <tr>
              <td>Domicilio:&nbsp;</td>
...
<!-- LISTADO MEDICOS -->
<center>
   <input type="button" value="Nuevo Paciente" onClick="mostarFormularioCrear()" >

   <div id="contenedorListadoPacientes"></div>
...
<script>
  ...
  function cargarPacientes(){
    ...
    $.ajax({
       url:"./Pacientes/mostrarPaciente.php",
       success:function(respuesta){
          $("#contenedorListadoPacientes").html(respuesta);
       }
    });

  }

  cargarPacientes();//carga la funcion al abrir la pagina


  function eliminarMedico(rut){

    $.ajax({
      url:"./Pacientes/eliminarPaciente.php?rut="+rut,
      success:function(respuesta){
...
//INSERTAR o MODIFICA MEDICO
  $("#formularioCrearMedico").submit(function(event){
       ...
       $.ajax({
         url:"./Pacientes/insertarPaciente.php",
  ...
  function datosUnMedico(rut){
     ...
     $.ajax({
        url:"./Pacientes/datosUnPaciente.php?txt_rut="+rut,
        success:function(respuesta){
		  ...
		  var sexo=datosRecibidos[4];
		  var fechaN=datosRecibidos[5];
          var domicilio=datosRecibidos[6];
          var fono=datosRecibidos[7];
          var nacionalidad=datosRecibidos[8];
